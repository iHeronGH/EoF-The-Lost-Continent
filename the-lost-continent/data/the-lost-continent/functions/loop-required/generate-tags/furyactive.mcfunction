...
execute if entity @s[tag=ShiftActive] run function the-lost-continent:loop-required/generate-tags/shiftactive
...
execute if entity @s[tag=FuryActive] run function the-lost-continent:loop-required/primaries/grant-buffs/leafwing-buffs
